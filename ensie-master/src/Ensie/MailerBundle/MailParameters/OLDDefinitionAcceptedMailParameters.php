...
class DefinitionAcceptedMailParameters extends AbstractMailParameters {
    ...
    {
        return "EnsieMailerBundle:User:sendDefinitionAccepted.html.twig";
    }
    ...
    function getSubject()
    {
        return "mail.user.definition_accepted";
    }
