...
class DefinitionAcceptedNotificationListener implements EventSubscriberInterface{
    ...
    {
        return array(
            DefinitionEvents::DEFINITION_ACCEPTED => array(array('addNotification')),
        );
    }
    ...
    public function addNotification(DefinitionValidationEvent $event)
    {
        $this->notificationService->createNotification(
            ...
            NotificationTemplate::IDENTIFIER_ACCEPTED,
