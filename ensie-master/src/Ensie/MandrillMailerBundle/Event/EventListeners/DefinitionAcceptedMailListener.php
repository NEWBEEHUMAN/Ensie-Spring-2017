...
class DefinitionAcceptedMailListener implements EventSubscriberInterface{
    ...
    {
        return array(
            DefinitionEvents::DEFINITION_ACCEPTED => array(array('definitionAccepted')),
        );
    }

    public function definitionAccepted(DefinitionValidationEvent $event)
    {
        ...
        if($user instanceof EnsieUser)
        {
            ...
            $this->mandrillMailSender->send($user, 'definition', 'accepted', $extraData);
        }
    }
}